...
include('../header.php');
?>
</div><TITLE>Tokopedia Checker</TITLE>
<script type="text/javascript" src="/anjing.js"></script>

<div class="rightside">
<div class="page-head">
<h1><i class="fa fa-flag"></i> Tokopedia Account Checker</h1>
</div>
<div class="content">
...
<b>Note: </b>Check Login, Check Saldo.</div>
<div class="box">
<div class="box-title">
<h3><i class="fa fa-credit-card"></i>
Tokopedia Account Checker</h3>
</div>
...
<span>WRONG </span><span class="label label-danger" id="wrong_count" style="color:white">0</span>
    ...
    <meta name="author" content="TC-ID Tools">
