...
if (empty($cpassword1)) {
    ...
    header('location:https://tcid.tk/account/profile/?msg=Data have not been filled completely');
    break;
...
if ($cpassword1 == $cpassword2) {
    ...
    if (mysql_num_rows($q) >= 1) {
        ...
        header('location:https://tcid.tk/account/profile/?msg=Change password success!');
    } else {
        //kalau password lama tidak sama
        header('location:https://tcid.tk/account/profile/?msg=Old password not correctly!');
    }
    
} else {
     //kalau password baru beda dengan confirm password
     header('location:https://tcid.tk/account/profile/?msg=Please fill confirm password correctly!');
}
