...
$username = "koe123_user"; //user database mysql
$password = "savegaza123";  //password database mysql
$dbname = "koe123_admin"; //nama database mysql
...
mysql_query("CREATE TABLE IF NOT EXISTS `user` (`email` varchar(32) NOT NULL, `password` varchar(255) NOT NULL, `credits` varchar(255) NOT NULL, `banned` varchar(255) NOT NULL, `admin` varchar(255) NOT NULL,`orders` varchar(255) NOT NULL, `regby` varchar(32) NOT NULL, `invitecode` varchar(255) NOT NULL, PRIMARY KEY (`email`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8");
